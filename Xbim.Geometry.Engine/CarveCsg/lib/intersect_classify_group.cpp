...
namespace carve {
  namespace csg {
    ...
    namespace {
      ...
      public:
        ...
        void classifyEasy(FLGroupList &a_loops_grouped,
                          ...
                          const carve::geom::RTreeNode<3, carve::mesh::Face<3> *> *poly_b_rtree, double EPSILON, double EPSILON2) const {
          performClassifyEasyFaceGroups(a_loops_grouped, poly_b, poly_b_rtree, vclass, FaceMaker0(collector, hooks), collector, hooks, EPSILON, EPSILON2);
          performClassifyEasyFaceGroups(b_loops_grouped, poly_a, poly_a_rtree, vclass, FaceMaker1(collector, hooks), collector, hooks, EPSILON, EPSILON2);
#if defined(CARVE_DEBUG)
        ...
        void classifyHard(FLGroupList &a_loops_grouped,
                          ...
                          carve::mesh::MeshSet<3> *poly_b,
                          const carve::geom::RTreeNode<3, carve::mesh::Face<3> *> *poly_b_rtree, double EPSILON, double EPSILON2) const {
          performClassifyHardFaceGroups(a_loops_grouped, poly_b, poly_b_rtree, FaceMaker0(collector, hooks), collector, hooks, EPSILON, EPSILON2);
          performClassifyHardFaceGroups(b_loops_grouped, poly_a, poly_a_rtree, FaceMaker1(collector, hooks), collector, hooks, EPSILON, EPSILON2);
#if defined(CARVE_DEBUG)
        ...
        void faceLoopWork(FLGroupList &a_loops_grouped,
                          ...
                          carve::mesh::MeshSet<3> *poly_b,
                          const carve::geom::RTreeNode<3, carve::mesh::Face<3> *> *poly_b_rtree, double EPSILON, double EPSILON2) const {
          performFaceLoopWork(poly_b, poly_b_rtree, a_loops_grouped, *this, collector, hooks,  EPSILON,  EPSILON2);
          performFaceLoopWork(poly_a, poly_a_rtree, b_loops_grouped, *this, collector, hooks,  EPSILON,  EPSILON2);
        }
    ...
    void CSG::classifyFaceGroups(const V2Set & /* shared_edges */,
                                 ...
                                 CSG::Collector &collector, double EPSILON, double EPSILON2) {
