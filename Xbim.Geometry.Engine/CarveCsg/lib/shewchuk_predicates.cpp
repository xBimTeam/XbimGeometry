...
#define Split(a, ahi, alo) \
  c = (double) (shewchuk::robust.splitter * a); \
  abig = (double) (c - a); \
  ahi = c - abig; \
  alo = a - ahi
...
#define Two_Square(a1, a0, x5, x4, x3, x2, x1, x0) \
  ...
  fprintf(stderr, "t4: %f %f %f\n", _l, _2, x1);   \
  Square(a1, _j, _1); \
  fprintf(stderr, "t5: %f %f\n", _j, _1);   \
  Two_Two_Sum(_j, _1, _l, _2, x5, x4, x3, x2); \
  fprintf(stderr, "t6: %f %f %f %f\n", x5, x4, x3, x2)
...
namespace shewchuk {
  ...
  */
  ...
  int grow_expansion_zeroelim(int elen, double *e, double b, double *h)       /* e and h can be the same. */
  {
    double Q, hh;
    INEXACT double Qnew;
    int eindex, hindex;
  ...
  int fast_expansion_sum(int elen, double *e, int flen, double *f, double *h)           /* h cannot be e or f. */
  {
    double Q;
    INEXACT double Qnew;
    INEXACT double bvirt;
  ...
  int linear_expansion_sum(int elen, double *e, int flen, double *f, double *h)         /* h cannot be e or f. */
  {
    double Q, q;
    INEXACT double Qnew;
    INEXACT double R;
  ...
  int linear_expansion_sum_zeroelim(int elen, double *e, int flen, double *f, double *h)/* h cannot be e or f. */
  {
    double Q, q, hh;
    INEXACT double Qnew;
    INEXACT double R;
  ...
  int scale_expansion(int elen, double *e, double b, double *h)            /* e and h cannot be the same. */
  {
    INEXACT double Q;
    INEXACT double sum;
  ...
  int compress(int elen, double *e, double *h)                         /* e and h may be the same. */
  {
    double Q, q;
    INEXACT double Qnew;
    int eindex, hindex;
    ...
    for (eindex = elen - 2; eindex >= 0; eindex--) {
      enow = e[eindex];
      Two_Sum(Q, enow, Qnew, q);
      fprintf(stderr, "Q=%f enow=%f Qnew=%f q=%f\n", Q, enow, Qnew, Q);
      if (q != 0) {
        h[bottom--] = Qnew;
        Q = q;
      } else {
  ...
  {
    INEXACT double axby1, axcy1, bxcy1, bxay1, cxay1, cxby1;
    double axby0, axcy0, bxcy0, bxay0, cxay0, cxby0;
    double aterms[4], bterms[4], cterms[4];
    INEXACT double aterms3, bterms3, cterms3;
    double v[8], w[12];
    int vlength, wlength;
  ...
  double orient2dadapt(const double *pa, const double *pb, const double *pc, double detsum)
  {
    INEXACT double acx, acy, bcx, bcy;
    ...
    det = estimate(4, B);
    errbound = shewchuk::robust.ccwerrboundB * detsum;
    ...
    errbound = shewchuk::robust.ccwerrboundC * detsum + shewchuk::robust.resulterrbound * Absolute(det);
  ...
  double orient2d(const double *pa, const double *pb, const double *pc)
  {
    ...
    errbound = shewchuk::robust.ccwerrboundA * detsum;
    if ((det >= errbound) || (-det >= errbound)) {
      return det;
    }
  ...
  {
    INEXACT double axby1, bxcy1, cxdy1, dxay1, axcy1, bxdy1;
    INEXACT double bxay1, cxby1, dxcy1, axdy1, cxay1, dxby1;
  ...
  double orient3dslow(const double *pa, const double *pb, const double *pc, const double *pd)
  {
    INEXACT double adx, ady, adz, bdx, bdy, bdz, cdx, cdy, cdz;
    double adxtail, adytail, adztail;
    double bdxtail, bdytail, bdztail;
    double cdxtail, cdytail, cdztail;
    double negate, negatetail;
    INEXACT double axby7, bxcy7, axcy7, bxay7, cxby7, cxay7;
  ...
  double orient3dadapt(const double *pa, const double *pb, const double *pc, const double *pd, double permanent)
  {
    ...
    errbound = shewchuk::robust.o3derrboundB * permanent;
    if ((det >= errbound) || (-det >= errbound)) {
      return det;
    }
    ...
    errbound = shewchuk::robust.o3derrboundC * permanent + shewchuk::robust.resulterrbound * Absolute(det);
  ...
  double orient3d(const double *pa, const double *pb, const double *pc, const double *pd)
  {
    ...
    errbound = shewchuk::robust.o3derrboundA * permanent;
    if ((det > errbound) || (-det > errbound)) {
      return det;
    }
  ...
  double incircleexact(const double *pa, const double *pb, const double *pc, const double *pd)
  {
    INEXACT double axby1, bxcy1, cxdy1, dxay1, axcy1, bxdy1;
    INEXACT double bxay1, cxby1, dxcy1, axdy1, cxay1, dxby1;
    double axby0, bxcy0, cxdy0, dxay0, axcy0, bxdy0;
  ...
  double incircleslow(const double *pa, const double *pb, const double *pc, const double *pd)
  {
  ...
  double incircleadapt(const double *pa, const double *pb, const double *pc, const double *pd, double permanent)
  {
    INEXACT double adx, bdx, cdx, ady, bdy, cdy;
    double det, errbound;
    ...
    det = estimate(finlength, fin1);
    errbound = shewchuk::robust.iccerrboundB * permanent;
    if ((det >= errbound) || (-det >= errbound)) {
      return det;
    }
    ...
    errbound = shewchuk::robust.iccerrboundC * permanent + shewchuk::robust.resulterrbound * Absolute(det);
  ...
  double incircle(const double *pa, const double *pb, const double *pc, const double *pd)
  {
    ...
    errbound = shewchuk::robust.iccerrboundA * permanent;
    if ((det > errbound) || (-det > errbound)) {
      return det;
    }
  ...
  double insphereexact(const double *pa, const double *pb, const double *pc, const double *pd, const double *pe)
  {
  ...
  double insphereslow(const double *pa, const double *pb, const double *pc, const double *pd, const double *pe)
  {
    ...
    double negate, negatetail;
    INEXACT double axby7, bxcy7, cxdy7, dxay7, axcy7, bxdy7;
    INEXACT double bxay7, cxby7, dxcy7, axdy7, cxay7, dxby7;
    double axby[8], bxcy[8], cxdy[8], dxay[8], axcy[8], bxdy[8];
    double bxay[8], cxby[8], dxcy[8], axdy[8], cxay[8], dxby[8];
    double ab[16], bc[16], cd[16], da[16], ac[16], bd[16];
    int ablen, bclen, cdlen, dalen, aclen, bdlen;
    double temp32a[32], temp32b[32], temp64a[64], temp64b[64], temp64c[64];
    int temp32alen, temp32blen, temp64alen, temp64blen, temp64clen;
    double temp128[128], temp192[192];
    int temp128len, temp192len;
    double detx[384], detxx[768], detxt[384], detxxt[768], detxtxt[768];
    int xlen, xxlen, xtlen, xxtlen, xtxtlen;
    double x1[1536], x2[2304];
    int x1len, x2len;
    double dety[384], detyy[768], detyt[384], detyyt[768], detytyt[768];
    int ylen, yylen, ytlen, yytlen, ytytlen;
    double y1[1536], y2[2304];
    int y1len, y2len;
    double detz[384], detzz[768], detzt[384], detzzt[768], detztzt[768];
    int zlen, zzlen, ztlen, zztlen, ztztlen;
    double z1[1536], z2[2304];
    int z1len, z2len;
    double detxy[4608];
    int xylen;
    double adet[6912], bdet[6912], cdet[6912], ddet[6912];
    int alen, blen, clen, dlen;
    double abdet[13824], cddet[13824], deter[27648];
    int deterlen;
    int i;
  ...
  double insphereadapt(const double *pa, const double *pb, const double *pc, const double *pd, const double *pe, double permanent)
  {
    INEXACT double aex, bex, cex, dex, aey, bey, cey, dey, aez, bez, cez, dez;
    double det, errbound;
    ...
    det = estimate(finlength, fin1);
    errbound = shewchuk::robust.isperrboundB * permanent;
    if ((det >= errbound) || (-det >= errbound)) {
      return det;
    }
    ...
    errbound = shewchuk::robust.isperrboundC * permanent + shewchuk::robust.resulterrbound * Absolute(det);
  ...
  double insphere(const double *pa, const double *pb, const double *pc, const double *pd, const double *pe)
  {
    ...
    permanent = ((cexdeyplus + dexceyplus) * bezplus
              ...
              * dlift;
    errbound = shewchuk::robust.isperrboundA * permanent;
    if ((det > errbound) || (-det > errbound)) {
      return det;
    }
