...
static inline bool facesAreCoplanar(const carve::mesh::MeshSet<3>::face_t *a, const carve::mesh::MeshSet<3>::face_t *b, double EPSILON) {
  ...
  return !carve::geom3d::planeIntersection(a->plane, b->plane, temp, EPSILON);
}
