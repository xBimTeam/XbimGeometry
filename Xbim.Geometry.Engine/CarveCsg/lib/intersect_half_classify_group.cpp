    ...
    namespace {
      ...
      public:
        ...
        void classifyEasy(FLGroupList & /* a_loops_grouped */,
          ...
          GroupPoly group_poly(poly_b, b_out);
          performClassifyEasyFaceGroups(b_loops_grouped, poly_a, poly_a_rtree, vclass, FaceMaker(), group_poly, hooks,  EPSILON,  EPSILON2);
#if defined(CARVE_DEBUG)
        ...
        void classifyHard(FLGroupList & /* a_loops_grouped */,
                          ...
                          const carve::geom::RTreeNode<3, carve::mesh::Face<3> *> *poly_b_rtree, double EPSILON, double EPSILON2) const {
          GroupPoly group_poly(poly_b, b_out);
          performClassifyHardFaceGroups(b_loops_grouped, poly_a, poly_a_rtree, FaceMaker(), group_poly, hooks, EPSILON, EPSILON2);
#if defined(CARVE_DEBUG)
        ...
        void faceLoopWork(FLGroupList & /* a_loops_grouped */,
                          ...
                          const carve::geom::RTreeNode<3, carve::mesh::Face<3> *> *poly_b_rtree, double EPSILON, double EPSILON2) const {
          GroupPoly group_poly(poly_b, b_out);
          performFaceLoopWork(poly_a, poly_a_rtree, b_loops_grouped, *this, group_poly, hooks, EPSILON, EPSILON2);
        }
