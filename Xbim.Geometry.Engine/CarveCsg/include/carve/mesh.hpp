...
#pragma once
#pragma warning (disable:4267) //disable for 64 bit compiles
...
namespace carve {
  ...
  namespace mesh {
    ...
    public:
      ...
      bool containsPoint(const vector_t &p, double EPSILON, double EPSILON2) const;
      bool containsPointInProjection(const vector_t &p, double EPSILON, double EPSILON2) const;
      bool simpleLineSegmentIntersection(
          const carve::geom::linesegment<ndim> &line,
          vector_t &intersection, double EPSILON) const;
