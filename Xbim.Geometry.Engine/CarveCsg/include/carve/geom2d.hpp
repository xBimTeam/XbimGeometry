...
namespace carve {
  namespace geom2d {
    ...
    bool pointInPolySimple(const std::vector<P2> &points, const P2 &p,double EPSILON);
    ...
    PolyInclusionInfo pointInPoly(const std::vector<P2> &points, const P2 &p, double EPSILON, double EPSILON2);
