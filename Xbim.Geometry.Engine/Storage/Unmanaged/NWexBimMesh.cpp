...
NWexBimMesh NWexBimMesh::CreateMesh(const TopoDS_Shape& shape, double tolerance, bool checkEdges)
{
...
// purpose  :
// =======================================================================
void NWexBimMesh::saveNodes(const NFaceMeshIterator& theFaceIter)
{
	...
	for (Standard_Integer aNodeIter = theFaceIter.NodeLower(); aNodeIter <= aNodeUpper; ++aNodeIter)
	{
		...
		BndBox.Add(BVH_Vec3f((float)(aNode.X()), (float)(aNode.Y()), (float)(aNode.Z())));
		AddPoint(aNode);;
	}
}
