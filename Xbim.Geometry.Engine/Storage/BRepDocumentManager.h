	...
	namespace Geometry
	{
		namespace Storage
		{
			...
			public:
				...
				/// </summary>
				property bool IsLoaded { virtual bool get() { return Ref()->IsDriverLoaded(); } }
				/// <summary>
				/// Number of documents open in the current session
				/// </summary>
				property int NbDocumentsInSession {virtual int get() { return Ref()->NbDocuments(); } }
				/// <summary>
				...
				virtual IXBRepDocument^ OpenSTEP(System::String^ path);
