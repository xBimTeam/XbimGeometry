	...
	namespace Geometry
	{
		namespace BRep
		{
			...
			public:
				...
				XPoint(const gp_Pnt2d& pnt2d) : _x(pnt2d.X()), _y(pnt2d.Y()), _z(0.0) {};
				XPoint(gp_Pnt2d* pPnt2d) : _x(pPnt2d->X()), _y(pPnt2d->Y()), _z(0.0) {};
				XPoint(const gp_XY& pnt2d) : _x(pnt2d.X()), _y(pnt2d.Y()), _z(0.0) {};
				XPoint(gp_XY* pPnt2d) : _x(pPnt2d->X()), _y(pPnt2d->Y()), _z(0.0) {};
