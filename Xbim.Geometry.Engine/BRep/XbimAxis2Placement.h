...
namespace Xbim
{
	namespace Geometry
	{
		namespace BRep
		{
			...
			public ref class XbimAxis2Placement : XbimHandle<Handle(Geom_Axis2Placement)>, IXAxis2Placement
			{
			public:
				XbimAxis2Placement(Handle(Geom_Axis2Placement) axis2) : XbimHandle(new Handle(Geom_Axis2Placement)(axis2)) { };
