...
void Xbim::Geometry::XbimGeometryCreatorV6::LogInfo(ILogger^ logger, Object^ entity, System::String^ format, ...array<Object^>^ arg)
{
	throw gcnew System::NotImplementedException();
}

void Xbim::Geometry::XbimGeometryCreatorV6::LogWarning(ILogger^ logger, Object^ entity, System::String^ format, ...array<Object^>^ arg)
{
	throw gcnew System::NotImplementedException();
}

void Xbim::Geometry::XbimGeometryCreatorV6::LogError(ILogger^ logger, Object^ entity, System::String^ format, ...array<Object^>^ arg)
{
	throw gcnew System::NotImplementedException();
}

void Xbim::Geometry::XbimGeometryCreatorV6::LogDebug(ILogger^ logger, Object^ entity, System::String^ format, ...array<Object^>^ arg)
{
	throw gcnew System::NotImplementedException();
}
...
IXbimGeometryObject^ Xbim::Geometry::XbimGeometryCreatorV6::Create(IIfcGeometricRepresentationItem^ geomRep, ILogger^)
{
	return Create(geomRep, nullptr, nullptr);
}

IXbimGeometryObject^ Xbim::Geometry::XbimGeometryCreatorV6::Create(IIfcGeometricRepresentationItem^ geomRep, IIfcAxis2Placement3D^ objectLocation, ILogger^)
{
	...
	try
	{
		if (geomRep == nullptr)
		{
			throw gcnew System::NullReferenceException("eometry Representation Item cannot be null");
		}
...
bool Xbim::Geometry::XbimGeometryCreatorV6::Is3D(IIfcCurve^ rep)
{
	try
	{
...
IIfcFacetedBrep^ Xbim::Geometry::XbimGeometryCreatorV6::CreateFacetedBrep(Xbim::Common::IModel^ model, IXbimSolid^ solid)
{
	throw gcnew System::NotImplementedException();
