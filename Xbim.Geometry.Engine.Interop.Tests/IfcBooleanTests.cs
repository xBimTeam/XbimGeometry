...
namespace Xbim.Geometry.Engine.Interop.Tests
{
    ...
    public class IfcBooleanTests
    {
        ...
        {
            var emptyBoolean = EntityRepository.GetGeometry<IIfcBooleanResult>(nameof(EmptyBooleanResultTest));
            Assert.IsTrue(emptyBoolean != null, "No IfcBooleanResult found");          
            var solid = geomEngine.CreateSolid(emptyBoolean, loggerFactory.CreateLogger<IfcBooleanTests>());
...
//                        Assert.IsFalse(solid.IsValid, "The solid is empty and not valid");
